...
import { Tooltip, Button, Badge, TooltipContent, TooltipTrigger } from '@/components/ui/'
						...
						>
							<Icon
								className={cn(
									...
									health.status === 'error' && 'text-rose-600',
									health.status === 'disconnected' && 'text-amber-600',
