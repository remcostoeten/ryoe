...
const ResourceCard = ({
    ...
    return (
        ...
        >
            ...
            >
                <Icon
                    className={`w-4 h-4 ${hasSpikes ? 'text-red-500' : 'text-muted-foreground'}`}
                />
            </motion.div>
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setResourceData((prev) => {
                ...
                return {
                    cpu: [...prev.cpu, generateDataPoint(45, 30, 0.08)].slice(
                        -maxPoints
                    ),
                    ...
                    network: [
                        ...prev.network,
                        generateDataPoint(25, 40, 0.1)
                    ].slice(-maxPoints),
                    memory: [
                        ...prev.memory,
                        generateDataPoint(70, 15, 0.04)
                    ].slice(-maxPoints)
                }
            })
                ...
                >
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <Activity
                                    className={`w-4 h-4 ${hasAnySpikes ? 'text-red-500' : 'text-muted-foreground'}`}
                                />
                            </motion.div>
