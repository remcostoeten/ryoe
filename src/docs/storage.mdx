...
Our application stores data in the following directory structure:

```bash
# Application data directory
~/.local/share/com.remcostoeten.notr/
...
// Output: /home/remcostoeten/.local/share/com.remcostoeten.notr
```
...
Our SQLite database is stored at:
...
```typescript
import { ConfigManager } from '@/lib/storage/config'
