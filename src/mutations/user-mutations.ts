...
import { useRegisterUser, useUpdateUserPreferences, useSwitchStorageType, setCurrentUserCache } from '@/api/services/auth-service'
...
export function useRegisterUser(options?: TMutationOptions<TUserProfile, TRegisterUserVariables>) {
	...
	return useMutation({
		...
		onMutate: async variables => {
			...
			await queryClient.cancelQueries({
				queryKey: QUERY_KEYS.USER_PROFILE(variables.userId),
			})
			await queryClient.cancelQueries({
