...
import type { TTag, TCreateTagData, TUpdateTagData } from '@/types/tags'
...
export function useDeleteTag() {
  ...
  return useMutation({
    ...
    onMutate: async (variables: TDeleteTagVariables) => {
      ...
      await queryClient.cancelQueries({ queryKey: TAG_QUERY_KEYS.detail(variables.id) })
      await queryClient.cancelQueries({ queryKey: TAG_QUERY_KEYS.lists() })
      ...
      queryClient.removeQueries({ queryKey: TAG_QUERY_KEYS.detail(variables.id) })
