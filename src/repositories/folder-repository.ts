...
export async function updateFolder(id: number, data: TUpdateFolderData): Promise<TRepositoryResult<TFolder>> {
...
export async function moveFolder(id: number, newParentId: number | null, newPosition?: number): Promise<TRepositoryResult<TFolder>> {
