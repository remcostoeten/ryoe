...
export function getEnvironmentConfig(): EnvironmentConfig {
	...
	if (!authToken) {
		authToken =
			'eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NTAyODMxNDgsImlkIjoiMmFhMzZjMTgtYjA3Ny00MzVkLWI5Y2QtM2EyNTIxMzZjNTY3IiwicmlkIjoiNjhhMDQ0NjQtMTc1ZC00ODgzLWJiOGItNWY4OGE4MDNlN2M5In0.3BY8McvaxvbbKkPA8J4Cq8MnyPKN_dCV9d1_yWSjFcD2Zeuojz8Ba9p8AV5xtTZbsWumpZB213NrLwLY49_5Aw'
	}
