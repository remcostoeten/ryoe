	...
	const docSections = [
		{
			...
			icon: HardDrive,
			path: '/docs/storage',
			topics: ['Local Storage', 'File System API', 'Path Resolution', 'Data Persistence'],
		},
		{
			title: 'Database Operations',
			description: 'Complete guide to querying and mutating data with SQLite and Drizzle ORM',
			icon: Database,
			path: '/docs/db-operations',
			topics: ['Query Patterns', 'Mutations', 'Transactions', 'Error Handling'],
		},
		{
			...
			topics: ['API Reference', 'Type Definitions', 'Examples', 'Best Practices'],
		},
		{
			...
			<div className='max-w-6xl mx-auto px-4 sm:px-6 space-y-10 pt-16 pb-10'>
				...
				<div className='text-center space-y-4'>
					...
					<p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
						Complete guide to storage, database operations, window management,
						technology stack, and architecture for our Tauri application
					</p>
				...
				<Card className='bg-muted/50 border-muted-foreground/20'>
					<CardHeader>
						...
						<CardDescription>
							New to our storage system? Start here for a quick overview.
						</CardDescription>
					</CardHeader>
					<CardContent className='space-y-4'>
						<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
							<div className='space-y-2'>
								<h4 className='font-medium'>1. Storage Setup</h4>
								<p className='text-sm text-muted-foreground'>
									Initialize local storage and configure file system paths
								</p>
							</div>
							<div className='space-y-2'>
								<h4 className='font-medium'>2. Database Connection</h4>
								<p className='text-sm text-muted-foreground'>
									Connect to SQLite database and run your first queries
								</p>
							</div>
							<div className='space-y-2'>
								<h4 className='font-medium'>3. API Integration</h4>
								<p className='text-sm text-muted-foreground'>
									Use our storage APIs in your components and services
								</p>
							</div>
						</div>
