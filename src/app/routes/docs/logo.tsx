      ...
      <div className="relative flex items-center justify-center" style={{ width: width, height: height }}>
        ...
        >
          ...
          >
            ...
            {/* Data streams */}
            <g>
              <path d="M8 18L16 22L24 18" stroke={primaryColor} strokeWidth="1" strokeLinecap="round" />
              <path d="M8 14L16 18L24 14" stroke={primaryColor} strokeWidth="1" strokeLinecap="round" />
              <path d="M8 10L16 14L24 10" stroke={primaryColor} strokeWidth="1" strokeLinecap="round" />
            </g>

            {/* Accent lines */}
            <g>
              <path d="M16 2V30" stroke={`${primaryColor}66`} strokeWidth="0.75" strokeDasharray="2 2" />
              <path d="M4 9L28 9" stroke={`${primaryColor}66`} strokeWidth="0.75" strokeDasharray="2 2" />
              <path d="M4 23L28 23" stroke={`${primaryColor}66`} strokeWidth="0.75" strokeDasharray="2 2" />
            </g>
            ...
            >
              ...
              >
                ...
                {logoBackgroundColor !== "transparent" && (
                  <circle cx="16" cy="16" r="15" fill={logoBackgroundColor} opacity="0.8" />
                )}
                ...
                <g>
                  <path d="M8 18L16 22L24 18" stroke={strokeColor} strokeWidth="1.2" strokeLinecap="round" />
                  <path d="M8 14L16 18L24 14" stroke={strokeColor} strokeWidth="1.2" strokeLinecap="round" />
                  <path d="M8 10L16 14L24 10" stroke={strokeColor} strokeWidth="1.2" strokeLinecap="round" />
                </g>

                {/* Accent lines - using stroke color with opacity */}
                <g>
                  <path d="M16 2V30" stroke={`${strokeColor}99`} strokeWidth="0.75" strokeDasharray="2 2" />
                  <path d="M4 9L28 9" stroke={`${strokeColor}99`} strokeWidth="0.75" strokeDasharray="2 2" />
                  <path d="M4 23L28 23" stroke={`${strokeColor}99`} strokeWidth="0.75" strokeDasharray="2 2" />
                </g>
...
export default function LogoConverter() {
  ...
  const handleFileUpload = (file: File) => {
    if (file.type === "text/plain" || file.name.endsWith(".tsx") || file.name.endsWith(".jsx")) {
  ...
  const generateSVGFromComponent = useCallback(() => {
    ...
    hexagon.setAttribute(
      "fill",
      uploadedComponent ? (fillColor === "transparent" ? "none" : `${fillColor}4D`) : `${primaryColor}1A`,
    )
    ...
    accents.forEach((d) => {
      const path = document.createElementNS("http://www.w3.org/2000/svg", "path")
      path.setAttribute("d", d)
      path.setAttribute("stroke", uploadedComponent ? `${strokeColor}99` : `${primaryColor}66`)
      ...
      <div className="container mx-auto p-6 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-[#999999]">
            Upload your React logo component and convert it to SVG or PNG format with custom dimensions and backgrounds.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-[#1a1a1a] border-[#333333]">
            <CardHeader>
              ...
              <CardDescription className="text-[#999999]">Configure your logo export options</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <p className="text-[#e5e5e5] mb-2">Drop your React component here</p>
                  <p className="text-[#999999] text-sm mb-3">Supports .tsx, .jsx, and .txt files</p>
                  <Button variant="outline" className="bg-[#333333] border-[#444444] text-[#e5e5e5] hover:bg-[#444444]">
                    Browse Files
                  </Button>
                </div>
                <input
                  ...
                  <div className="bg-[#222222] border border-[#333333] rounded p-3">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#e5e5e5] text-sm">{uploadedFileName}</span>
                        <Badge className="bg-[#333333] text-[#999999] text-xs">Animations Stripped</Badge>
                      </div>
                      <Button
                        variant="ghost"
                        size="sm"
                    ...
                    <div className="text-xs text-[#999999] bg-[#1a1a1a] p-2 rounded max-h-20 overflow-y-auto">
                      <p className="mb-1">✓ Removed framer-motion imports and animations</p>
                      <p className="mb-1">✓ Stripped motion prefixes and animation props</p>
              ...
              <div className="space-y-2">
                ...
                <Select value={format} onValueChange={(value: "png" | "svg") => setFormat(value)}>
                  ...
                  <SelectContent className="bg-[#222222] border-[#333333]">
                    <SelectItem value="png" className="text-[#e5e5e5] focus:bg-[#333333]">
                      PNG (Raster)
                    </SelectItem>
                    <SelectItem value="svg" className="text-[#e5e5e5] focus:bg-[#333333]">
                      SVG (Vector)
                    </SelectItem>
                  </SelectContent>
                </Select>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      id="custom-bg"
                      type="color"
                      value={backgroundColor === "transparent" ? "#0b0b0b" : backgroundColor}
              ...
              {uploadedComponent && (
                <>
                  <div className="space-y-4">
                    ...
                    {/* Stroke/Line Color */}
                    <div className="space-y-2">
                      <Label htmlFor="stroke-color" className="text-[#999999]">
                        Stroke/Line Color
                      </Label>
                      <div className="flex gap-2">
                        <Input
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          id="fill-color"
                          type="color"
                          value={fillColor === "transparent" ? "#333333" : fillColor}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="logo-bg-color" className="text-[#999999]">
                        Logo Background
                      </Label>
                      <div className="flex gap-2">
                        <Input
                          id="logo-bg-color"
                          type="color"
                          value={logoBackgroundColor === "transparent" ? "#1a1a1a" : logoBackgroundColor}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="svg-bg-color" className="text-[#999999]">
                        SVG Background
                      </Label>
                      <div className="flex gap-2">
                        <Input
                          id="svg-bg-color"
                          type="color"
                          value={svgBackgroundColor === "transparent" ? "#1a1a1a" : svgBackgroundColor}
                          onChange={(e) => setSvgBackgroundColor(e.target.value)}
                          className="w-16 h-10 p-1 bg-[#222222] border-[#333333]"
                        />
                        <Input
              ...
              >
                ...
                {isGenerating ? "Generating..." : `Download as ${format.toUpperCase()}`}
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#1a1a1a] border-[#333333]">
            <CardHeader>
              ...
              <CardDescription className="text-[#999999]">
                Live preview of your {uploadedComponent ? "uploaded component" : "logo"} with current settings
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="text-sm text-[#999999]">
                  Size: {width} × {height}px | Format: {format.toUpperCase()} | Background:{" "}
                ...
                <div
                  ...
                  style={{
                    ...
                    backgroundPosition:
                      backgroundColor === "transparent" ? "0 0, 0 10px, 10px -10px, -10px 0px" : "auto",
                  }}
                >
                  {uploadedComponent ? (
