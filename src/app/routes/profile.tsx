    ...
    return (
      <div className="min-h-screen p-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400">Please complete onboarding to access your profile.</p>
        </div>
      </div>
    )
  }
        ...
        >
          ...
          <div className="space-y-6 pt-6">
            ...
            <div className="space-y-3">
              <label className="block text-gray-300 text-sm font-medium">Storage Type</label>
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 border border-rose-400/30 rounded-lg bg-rose-500/5">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="text-rose-400 font-medium">Reset All Data</h4>
                    <p className="text-gray-400 text-sm mt-1">
                      This will completely wipe all database tables and local storage.
                      The onboarding flow will restart when you reload the app.
                    </p>
                  </div>
                </div>
