...
import { getUserProfile, getCurrentUser, checkOnboardingStatus } from '@/api/services/auth-service'
...
export function useUserProfile(id: number, options?: TQueryOptions<TUserProfile>) {
	return useQuery({
