    ...
    if (!toastFns) {
        toastFns = {
            ...
            neutral: (message: string, duration?: number) =>
                addToast(message, 'neutral', duration)
        }
    }
}
...
function ToastItem({
    ...
    const icons = {
        success: (
            <CheckCircle className="shrink-0 w-[18px] h-[18px] text-emerald-400" />
        ),
        error: (
            <AlertCircle className="shrink-0 w-[18px] h-[18px] text-red-400" />
        ),
        warning: (
            <AlertCircle className="shrink-0 w-[18px] h-[18px] text-amber-400" />
        ),
        info: <Bell className="shrink-0 w-[18px] h-[18px] text-blue-400" />,
        neutral: (
            <AlertCircle className="shrink-0 w-[18px] h-[18px] text-gray-400" />
        )
    }
