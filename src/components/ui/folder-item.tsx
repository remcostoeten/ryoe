...
import type { TFolder, TNote, TDragState } from "@/modules/folder-management/types"
                    ...
                    <CollapsibleTrigger asChild>
                        ...
                        >
                            <div className="flex items-center gap-2 min-w-0 flex-1 overflow-hidden">
                                ...
                                {folder.isFavorite && <Star className="h-3.5 w-3.5 text-amber-500 fill-current flex-shrink-0" />}
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                >
                                    {(folder.children?.length || 0) + (showNotes ? notes.length : 0)}
                                </span>
                            </div>
                        </Button>
                    </CollapsibleTrigger>
