							...
							<PopoverTrigger asChild>
								<div className='flex cursor-pointer items-center space-x-1 text-gray-400 hover:text-gray-200 transition-colors'>
									...
									<span className='font-mono'>
										{isLoadingCommit ? '...' : commitInfo.hash}
									</span>
								</div>
							</PopoverTrigger>
							<PopoverContent
								className='w-80 bg-[#1f1f1f] border-[#333] p-0 rounded-md shadow-xl'
								sideOffset={5}
							>
								...
								<div className='flex items-center space-x-1 text-gray-400'>
									...
									<span>
										{commitInfo.timestamp
											? new Date(commitInfo.timestamp).toLocaleTimeString()
											: '...'}
									</span>
								</div>
							</TooltipTrigger>
