...
export async function fetchGitTree(repoUrl: string, branch = "master", maxCommits = 10): Promise<GitCommit[]> {
  ...
  try {
    ...
    return commits.map((commit, index) => {
      ...
      const authorAvatar =
        commit.author?.avatar_url || "https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y"
